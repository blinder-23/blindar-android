...
class MealDeserializerTest {
    ...
    private val deserializer = com.practice.neisapi.meal.MealDeserializer()
    ...
    @Test
    fun parseHeader() {
        val expected = com.practice.neisapi.meal.pojo.MealHeader(
            listTotalCount = 20,
            resultCode = com.practice.neisapi.meal.pojo.MealResultCode(
                code = "INFO-000",
                message = "정상 처리되었습니다."
            )
        )
    ...
    fun parseMeal() {
        ...
        println(actual)
        assertEquals(com.practice.neisapi.meal.seoulOfficeCode, actual.officeCode)
    }
    ...
    fun parseCalorie_Fail() {
        ...
        } catch (e: com.practice.neisapi.meal.MealDeserializerException) {
            exceptionOccur = true
        } finally {
    ...
    fun parseMenu() {
        ...
        val expectedList = listOf(
            com.practice.neisapi.meal.pojo.Menu(
                name = "롤케이크",
    ...
    fun parseOrigins() {
        ...
        val expectedList = listOf(
            com.practice.neisapi.meal.pojo.Origin(
                ingredient = "쌀",
                originCountry = "국내산",
            ),
            com.practice.neisapi.meal.pojo.Origin(
    ...
    fun parseNutrients() {
        ...
        val expectedList = listOf(
            com.practice.neisapi.meal.pojo.Nutrient(
                name = "탄수화물",
                unit = "g",
                amount = 136.2,
            ),
